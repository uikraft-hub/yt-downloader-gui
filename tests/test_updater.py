...
class TestUpdater(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_api_response = {
            "tag_name": "2023.12.30",
            "assets": [
                {"name": "yt-dlp.exe", "browser_download_url": "https://fake.url/yt-dlp.exe"},
    ...
    def test_download_yt_success(self, mock_file, mock_chmod, mock_replace, mock_copy, mock_urlopen, mock_get_version):
        ...
        mock_replace.assert_called_once_with(self.updater.yt_dlp_path + ".new", self.updater.yt_dlp_path)
        
        # Verify that chmod was called
        self.assertTrue(mock_chmod.called)

        # Verify progress callbacks
        self.assertIn("Downloading yt-dlp 2023.12.30...", [call[0][0] for call in progress_callback.call_args_list])
        self.assertIn(f"yt-dlp updated to 2023.12.30 at {self.updater.yt_dlp_path}", [call[0][0] for call in progress_callback.call_args_list])
